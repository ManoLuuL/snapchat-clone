...
const ChatCamera = () => {
  ...
  return (
    <>
      <div
        className={twMerge(
          "aspect-[9/16] flex flex-col items-center justify-center h-[80%]",
          "bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-sigColorBgBorder mx-auto lg:mx-0"
        )}
      >
        <div
        ...
        >
          <Image
            ...
            className="hover:opacity-90 w-[150px] h-auto"
            alt="Camera Icon"
          />
